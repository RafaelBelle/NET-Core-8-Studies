...
public class RegisterUserTest : CashFlowClassFixture
{
    ...
    public async Task Error_Empty_Name(string cultureInfo)
    {
        ...
        var expectedMessage = ResourceErrorMessages.ResourceManager.GetString(nameof(ResourceErrorMessages.NAME_EMPTY), new System.Globalization.CultureInfo(cultureInfo));
