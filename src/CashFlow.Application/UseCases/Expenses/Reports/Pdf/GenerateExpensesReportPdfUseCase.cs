...
internal class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach (var expense in expenses)
        {
            ...
            AddAmountForEpense(row.Cells[3], expense.Amount);
            ...
            if (!string.IsNullOrWhiteSpace(expense.Description))
            {
                ...
                descriptionRow.Cells[0].MergeRight = 3;
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Rafael Belle";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var row = table.AddRow();
        row.Cells[0].AddImage(""); // add picture to the assembly resource
    ...
    private void AddAmountForEpense(Cell cell, decimal expenseAmount)
    {
